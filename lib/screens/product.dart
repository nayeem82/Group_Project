...
import 'package:ecommerce/widgets.dart/size.dart';
import 'package:ecommerce/widgets.dart/swipe.dart';
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 24.0, right: 24.0, left: 20.0, bottom: 4.0),
                    child: Text(
                      "${documentData['name']}",
